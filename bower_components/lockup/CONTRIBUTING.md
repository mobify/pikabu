...
Create an issue in our [issue tracker](https://github.com/mobify/lockup/issues) describing the problem. Follow the steps below, fixing the bug in your fork. Don't forget to add tests!
...
```
git clone https://github.com/your-username/lockup.git
```
...
Push to your fork, and open a [pull request](https://github.com/mobify/lockup/compare). Please ensure you describe your changes in your pull request, as they have a higher likelihood of being merged.
